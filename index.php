...
<body>
	...
	<form action="core/handleForms.php" method="POST">
		...
		<p><label for="contact_number">Contact Number Level</label> <input type="text" name="contact_number"></p>
		<p><label for="date_of_reservation">Date of Reservation</label> <input type="text" name="date_of_reservation"></p>
		<p><label for="time_of_reservation">Time of Reservation</label> <input type="text" name="time_of_reservation"></p>
		<p><label for="services">Services</label>services<input type="text" name="services"></p>
        <p><label for="request_barber">Request Barber</label> <input type="text" name="request_barber">
